...
SCORE_DIR <- normalizePath(file.path(ROOT_DIR, "..", "..", "3.2 双边关系分析基于月度政治分数",
                                     "全新事件研究法", "data"), winslash = "/")
OUT_DIR <- "C:/Users/胡克劳/Desktop/311工程/3 实证结果/修订补充检验_202607/01_同方程四库交叉验证/results"
